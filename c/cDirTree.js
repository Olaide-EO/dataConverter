...
const dirTree = require("./cDirectoryConverter");
const flatten = require('tree-flatten');

const filteredTree = dirTree("./C-master", { extensions: /\.(c|h)$/ });
...
fs.writeFile("./cDataMain.js", JSON.stringify(flattenTree), function(err) {
    if(err) {
